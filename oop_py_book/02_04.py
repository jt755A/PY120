'''
4. Add a class method to your Car class that calculates and prints any 
car's average gas mileage (miles per gallon). You can compute the 
mileage by dividing the distance traveled (in miles) 
by the fuel burned (in gallons).
'''
...
class Car:
    ...
    @classmethod
    def avg_mpg(cls, distance, galls_used):
        cls.mpg = distance / galls_used
        print(f'Your average gas mileage is {cls.mpg:.1f} miles per gallon')
